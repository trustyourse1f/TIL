...
- [Scikit-Learn 라이브러리](#Scikit-Learn-라이브러리)
- [Scikit-Learn의 데이터 표현 방식](#Scikit-Learn의-데이터-표현-방식)
  - [특징 행렬(Feature Matrix)](#특징-행렬(Feature Matrix))
  - [대상 벡터(Target Vector)](#대상-벡터(Target Vector))
- [Scikit-Learn Estimator API 기본 활용 절차](#Scikit-Learn-Estimator-API-기본-활용-절차)
  - [1. 데이터 준비](#1.-데이터-준비)
  - [2. 모델 클래스 선택](#2.-모델 클래스-선택)
  - [3. 모델 인스턴스 생성과 하이퍼파라미터 선택](#3.-모델-인스턴스-생성과-하이퍼파라미터-선택)
  - [4. 특징 행렬과 대상 벡터 준비](#4.-특징-행렬과-대상-벡터-준비)
  - [5. 모델을 데이터에 적합](#5.-모델을-데이터에-적합)
  - [6. 새로운 데이터를 이용해 예측](#6.-새로운-데이터를-이용해-예측)
  - [7. 모델 평가](#7.-모델-평가)
- [훈련 데이터와 테스트 데이터](#훈련-데이터와-테스트-데이터)
  - [훈련 데이터와 테스트 데이터의 분리](#훈련-데이터와-테스트-데이터의-분리)
- [하이퍼 파라미터의 선택](#하이퍼-파라미터의-선택)
- [주요 정리](#주요-정리)
...
![image-20220502213040747](2. 머신러닝의 이해.assets/image-20220502213040747.png)
...
![image-20220502213058025](2. 머신러닝의 이해.assets/image-20220502213058025.png)
...
![image-20220502213119254](2. 머신러닝의 이해.assets/image-20220502213119254.png)
